			...
			<div class="ui_content">
				<div class="ui_tb">
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<c:forEach items="${sh}" var="r">
						<tr>
							<td>${r.houseShen }-${r.houseCity }</td>
							...
							<td>
								<c:if test="${r.verify == 0 }">
							    	<a href="${pageContext.request.contextPath }/servlet/AdminServlet?method=up&id=${r.houseId}" class="edit">通过</a> 
							    </c:if>	
							    <c:if test="${r.verify == 1 }">
							    	<a href="${pageContext.request.contextPath }/servlet/AdminServlet?method=up1&id=${r.houseId}" class="edit">下架</a> 
							    </c:if>							
								<a href="${pageContext.request.contextPath }/servlet/AdminServlet?method=del1&id=${r.houseId }">删除</a>
							</td>
						</tr>
						</c:forEach>						
					</table>

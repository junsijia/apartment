	     ...
	     <tr>
	      ...
	      <td>
	       ...
	       <c:forEach items="${city }" var="city">
	        <a data-nav-sign="on" data-nav-name="city" data-nav-value="${city.rentHouseCity }" href="javascript:;">${city.rentHouseCity }</a>	       
	       </c:forEach>
	      </td>
	     </tr>
	     <tr>
	      ...
	      <td>
	       ...
	       <a data-nav-sign="on" data-nav-name="price" data-nav-value="500-1000" href="javascript:;">500-1000</a>
	       <a data-nav-sign="on" data-nav-name="price" data-nav-value="1001-2000" href="javascript:;">1001-2000</a>
	       <a data-nav-sign="on" data-nav-name="price" data-nav-value="2001-3000" href="javascript:;">2001-3000</a>
	       <a data-nav-sign="on" data-nav-name="price" data-nav-value="3001-4000" href="javascript:;">3001-4000</a>
	       <a data-nav-sign="on" data-nav-name="price" data-nav-value="4001" href="javascript:;">4000以上</a>	       
	      </td>
	     </tr>
	     <tr>
	      <th>面积：</th>
	     ...
	     <tr>
	      ...
	      <td>
	       ...
	       <c:forEach items="${type }"  var="type">
	        <a data-nav-sign="on" data-nav-name="type" data-nav-value="${type.rentHouseRoom }"  href="javascript:;">${type.rentHouseRoom }</a>
		   </c:forEach>
	      </td>
	     </tr>
	    </table>
<!-- 	    <div class="paixu">
	  ...
	  <div class="width1190">
	   ...
	   <c:forEach items="${pb.data}" var="p">
	    <dl>
	     <dt><a href="${pageContext.request.contextPath }/servlet/InfoServlet?method=getByRentId&id=${p.rentHouseId}"><img src="${pageContext.request.contextPath }/${p.rentHousePicture}" width="286" height="188"  /></a></dt>
	     <dd>
	      <h3><a href="${pageContext.request.contextPath }/servlet/InfoServlet?method=getByRentId&id=${p.rentHouseId}">${fn:substring(p.rentHouseAddress,0,10) }...</a></h3>
	      <div class="pro-wei">
	       <strong class="red">${p.rentHouseCity }</strong>
	      </div>
	      <div class="pro-fang">${p.rentHouseRoom } | ${p.rentHouseArea }平 </div>
	      <div class="pra-fa">发布人：${p.username }  发布时间：${p.publishdate }</div>
	     </dd>
	     <div class="price">¥ <strong>${p.rentHousePrice }</strong><span class="font12">元/月</span></div>
	   ...
	   <div class="pro-right">
	    ...
	    <div class="right-pro">
	     <c:forEach items="${house }" var="h">
	      <dl>
	      	<dt><a href="${pageContext.request.contextPath }/servlet/InfoServlet?method=getByRentId&id=${h.rentHouseId}"><img src="${pageContext.request.contextPath }/${h.rentHousePicture}" width="135" height="88" /></a></dt>
	      	<dd>
	      	 <h3><a href="${pageContext.request.contextPath }/servlet/InfoServlet?method=getByRentId&id=${h.rentHouseId}">${fn:substring(h.rentHouseAddress,0,10)}...</a></h3>
	      	 <div class="pro-fang">${h.rentHouseRoom } ${h.rentHouseArea }平 ${h.rentHouseDecoration }</div>
	      	 <div class="right-price">${h.rentHousePrice }元/月</div>
	      	</dd>
	      </dl>
	     </c:forEach>
	    </div><!--right-pro/-->

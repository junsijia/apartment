  ...
  <body>
	 ...
	 <div class="content">
	  <div class="width1190">
	    ...
	    <form action="${pageContext.request.contextPath }/servlet/FaBuServlet?method=saleFaBuAdd" method="post" enctype="multipart/form-data">			     	   
	     <table class="grinfo">	     	
	        <tbody>
		        <tr>
			        <th>房源区域：</th>
		        ...
		        <tr>
			        <th>价 &nbsp; &nbsp;格：</th>
			        <td>
			        	<input class="inp inw" type="number" id="price" name="price" value="" min="1">万
			        </td>
		        </tr>
		        <tr>
			        <th>落成时间：</th>
		        ...
		        <tr>
			        <th>住宅类型：</th>
			        <td>
						<input type="radio" value="普通住宅" id="housetype" name="housetype">
				        <label for="rbSex1">普通住宅</label>
				        <input type="radio" value="高级住宅" id="housetype" name="housetype">
				        <label for="rbSex2">高级住宅</label>
				        <input type="radio" value="豪华住宅" id="housetype" name="housetype">
				        <label for="rbSex1">豪华住宅</label>				        
				   	</td>
		        </tr>			        
		        <tr>
		        ...
		        <tr>
			        ...
			        <td colspan="2">
				        <label class="butt" id="butt">
				        	<input type="submit" class="member_mod_buttom"  value="发布出售" />
				        </label>
			        </td>
		        </tr>
	        </tbody>
	...
	<script type="text/javascript">
		...
		function aa(){
			...
			var price = $("#price").val();
			var date = $("#date").val();
			var housetype=$('input:radio[name="housetype"]:checked').val();
			var sign = $("#sign").val();
			...
			location.href="${pageContext.request.contextPath }/servlet/FaBuServlet?method=rentFaBuAdd&shen="+
					...
					price+"&date="+date+"&housetype="+housetype+"&sign="+sign;
			}
		}
